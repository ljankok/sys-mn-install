...
The steps the instal script takes are mostly based on the articleof [Johnp](https://medium.com/@BlockchainFoundry/syscoin-3-0-masternode-setup-instructions-572576c7163f)
